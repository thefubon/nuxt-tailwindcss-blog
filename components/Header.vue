  ...
  <nav class="flex fixed w-full items-center justify-between px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-10">
      ...
      >
        <div v-show="isDrop" class="absolute top-12 inset-x-0 transition-opacity">
          <ul class="transition-opacity flex flex-col bg-white rounded shadow-lg overflow-hidden">
            <li><NuxtLink class="flex items-center py-2 px-4 hover:bg-indigo-500 hover:text-white" to="/">Home</NuxtLink></li>
            <li><NuxtLink class="flex items-center py-2 px-4 hover:bg-indigo-500 hover:text-white" to="/about">About</NuxtLink></li>
          </ul>
        </div>
      </transition>
    </div>
    ...
    >
      ...
      <ul @click="isOpen = false">
        <li><NuxtLink class="flex items-center p-4 hover:bg-indigo-500 hover:text-white" to="/">Home</NuxtLink></li>
        <li><NuxtLink class="flex items-center p-4 hover:bg-indigo-500 hover:text-white" to="/about">About</NuxtLink></li>
      </ul>
